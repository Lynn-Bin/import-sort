...
A prettier plugin to sort import declarations by provided RegEx order.Refactor based on @trivago/prettier-plugin-sort-imports version 2.0.4
...
```shell script
npm install --save-dev @Lynn-Bin/import-sort
```
